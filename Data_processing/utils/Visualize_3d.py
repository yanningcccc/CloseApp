...
class Gui_3d(object):
    ...
    def visualize_joints_trajectory(self, points, color_s=np.array([0,0,1]), color_e=np.array([1,0,1])):
...
if __name__ == '__main__':
    ...
    gt_joints = np.load('Temp\GT_joint.npy')
    pred_joints = np.load('Temp\pred_joint.npy')
    v3d_joints = np.load('Temp\V3dpred_joint.npy')

    gui.visualize_joints_trajectory(gt_joints, color_s=np.array([0,0,1]), color_e=np.array([1,0,1]))

    gui.visualize_joints_trajectory(pred_joints, color_s=np.array([0,1,1]), color_e=np.array([1,1,0]))

    gui.visualize_joints_trajectory(v3d_joints, color_s=np.array([0,0,0]), color_e=np.array([0,1,0]))
